...
- [maplibre-contourmap](https://github.com/AbelVM/maplibre-contourmap) - Renders contour lines from a scattered points vector (tiled or geoJSON) layer in MapLibre GL JS. [demo](https://abelvm.github.io/maplibre-contourmap/example/)
